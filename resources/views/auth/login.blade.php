...
<head>
    ...
    <title>Masuk Aplikasi - Masjid Nur Ilahi</title>
        ...
        <div class="row">
            <div class="col-xl-7">
                ...
                <!--img class="bg-img-cover bg-center" src="{{ url('cuba/assets/images/login/login-2.jpeg') }}"
                    alt="looginpage"-->
                <img class="bg-img-cover bg-center" src="{{ url('https://ik.imagekit.io/tvlk/blog/2023/09/Masjid-Nabawi-1024x660.jpg?tr=dpr-2,w-675') }}"
                    alt="looginpage">
            </div>
