...
@section('title', 'Data Mustahik — Masjid Nur Ilahi')
@section('content')
        ...
        <div class="page-title">
            <div class="card card-absolute">
                <div class="card-header bg-primary">
                    <h5 class="text-white">Data Mustahik</h5>
                </div>
                <div class="card-body">
                    <p>Dibawah ini adalah data mustahik yang telah anda tambahkan. Data dibawah juga bisa anda
                            ...
                            <table class="display" id="auto-fill">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('mustahik.edit', $item->id) }}"
                                            ...
                                            <form action="{{ route('mustahik.destroy', $item->id) }}"
