...
@section('title', 'Tambah Data Galeri — Masjid Nur Ilahi')
@section('content')
    ...
    <div class="container-fluid">
        <div class="page-title">
            <div class="card card-absolute mt-5 mt-md-4">
                ...
                <div class="card-body">
                    <p>
                        Dibawah ini adalah halaman untuk upload foto galeri. <span class="d-none d-md-inline">
                            Foto yang telah diupload akan ditampilkan pada halaman galeri website masjid.
                        </span>
                    </p>
                </div>
            </div>
                ...
                <div class="card">
                    ...
                    <form method="POST" action="{{route('galleries.store')}}" enctype="multipart/form-data"
                        ...
                        <div class="card-footer">
                            <button type="submit" class="btn btn-primary m-r-15">Upload</button>
                        </div>
                    </form>
                </div>
            </div>
