...
@section('title', 'Galeri Foto — Masjid Nur Ilahi')
@section('content')
        ...
        <div class="container-fluid">
            <div class="page-title">
                <div class="card card-absolute mt-5 mt-md-4">
                    ...
                    <div class="card-body">
                        <p>
                            Dibawah ini adalah foto yang telah diupload. <span class="d-none d-md-inline">
                                Foto dibawah bisa dilihat dengan menekan foto yang ingin dilihat, disana juga bisa mendownload
                                foto dan menghapusnya. Ingin upload foto?
                                tambah foto
                                <a href="{{ url('/dashboard/galleries/create') }}">disini ⇾</a>
                            </span>
                        </p>
                    </div>
                </div>
                                ...
                                <figure class="col-xl-3 col-md-4 col-6" itemprop="associatedMedia" itemscope=""><a
                                    ...
                                    <figcaption itemprop="caption description">
                                        <a href="{{ url('storage/images/' . $item->foto) }}"
                                            class="btn btn-success py-1 px-2">
