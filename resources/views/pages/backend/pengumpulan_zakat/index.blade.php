...
@section('title', 'Data Pengumpulan Zakat — Masjid Nur Ilahi')
@section('content')
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <div class="d-flex justify-content-between">
                                                <!-- Tombol Edit -->
                                                <a href="{{ route('pengumpulan_zakat.edit', $item->id) }}" class="btn btn-info px-2">
                                                ...
                                                <!-- Tombol Hapus -->
                                                <form action="{{ route('pengumpulan_zakat.destroy', $item->id) }}" method="POST" class="d-inline">
                                                    @csrf
                                                    @method('delete')
