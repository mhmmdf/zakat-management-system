...
@section('title', 'Data Kategori Mustahik — Masjid Nur Ilahi')
@section('content')
        ...
        <div class="page-title">
            <div class="card card-absolute">
                <div class="card-header bg-primary">
                    <h5 class="text-white">Kategori Mustahik</h5>
                </div>
                <div class="card-body">
                    <p>Dibawah ini adalah data kategori mustahik yang berlaku di DKM. Data ini nantinya akan dibawa
                        untuk kategori mustahik yang akan didistribusikan.</p>
                    </p>
                </div>
            </div>
        </div>
                            ...
                            <table class="display" id="auto-fill">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $item->jumlah_hak }}%</td>
                                        <td>
                                            <form action="{{ route('kategori_mustahik.destroy', $item->id) }}"
