...
@section('title', 'Tambah Data Kategori Mustahik — Masjid Nur Ilahi')
@section('content')
            ...
            <div class="card card-absolute">
                ...
                <div class="card-body">
                    <p>
                        ...
                        ini dengan benar dan seksama sesuai aturan yang ditulis.
                    </p>
                </div>
            </div>
        </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-row">
                                ...
                                <label for="exampleFormControlInput1">Jumlah hak <span
                                        class="text-danger">*</span></label>
                                <div class="input-group mb-3">
                                    <input required type="number" class="form-control" name="jumlah_hak"
                                        aria-describedby="basic-addon1">
                                </div>
                                <p>*Masukkan jumlah hak dengan angka saja, sistem akan menyimpan dalam bentuk %</p>
                            </div>
                        </div>
